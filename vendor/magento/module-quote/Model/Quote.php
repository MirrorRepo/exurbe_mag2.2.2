...
class Quote extends AbstractExtensibleModel implements \Magento\Quote\Api\Data\CartInterface
{
    ...
    public function isVirtual()
    {
        ...
        foreach ($this->getItemsCollection() as $_item) {
            ...
            $countItems++;
            //echo $_item->getProduct()->getTypeId();
            //print_r($_item->getProduct()->getAttributeText('gift_card_type'));
            //echo $_item->getProduct()->getGiftCardType();
          //  echo $_item->getProduct()->getIsVirtual();
