...
class Collection extends \PHPCuong\Faq\Model\ResourceModel\Faq\Collection implements \Magento\Framework\Api\Search\SearchResultInterface
{
    /**
     * Aggregations
     *
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->joinLeft(
            ['faq_category_id' => $this->getTable('phpcuong_faq_category_id')],
