...
class Topmenu
{
    ...
    public function afterGetHtml(\Magento\Theme\Block\Html\Topmenu $subject, $result)
    {
        if ($this->isAddLinkToFrontend())
            $result .= '<li class="level0 nav-10 level-top ui-menu-item"><a href="' . $this->_urlInterface->getUrl('instagram/gallery') . '" class="level-top ui-corner-all" role="presentation">'. __("Instagram Gallery").'</a></li>';
