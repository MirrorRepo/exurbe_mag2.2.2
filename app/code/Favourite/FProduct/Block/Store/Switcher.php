 ...
 */
namespace Favourite\FProduct\Block\Store;
...
class Switcher extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _loadData()
    {
        ...
        $storeCollection = $this->_storeFactory->create()->getCollection()->group('code')->addWebsiteFilter($websiteId)->addAttributeToSort('code');
